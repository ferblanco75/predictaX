...
| Analytics consent | Store user cookie choices | Local consent categories, timestamp, consent version | Consent | Browser localStorage | Until user changes preferences or consent version changes |
...
- Cookie consent persistence to backend for logged-in users.
