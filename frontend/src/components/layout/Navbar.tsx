...
export function Navbar() {
  ...
  return (
    <nav className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50" role="navigation" aria-label="Navegación principal">
      <div className="container mx-auto px-4">
        ...
        {/* Categories tabs */}
        <div className="flex items-center space-x-1 overflow-x-auto pb-2 scrollbar-hide" role="tablist" aria-label="Categorías de mercados">
          <Link
            href="/markets"
